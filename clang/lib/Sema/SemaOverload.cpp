...
///     the operands -- normative per the backtick design's Sec. 17.4, and the
///     reason the callee is never resolved before overload resolution sees
///     the arguments (the GCC DEV-G05 defect was exactly that);
