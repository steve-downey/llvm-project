...
//
// The first pair of RUN lines is the strongest form of the inheritance claim
// available: the SAME function bodies are compiled twice, once written with
// operator syntax and once written as explicit calls, and the two modules must
// be byte-identical. Not "both compile" and not "both call the right symbol" --
// identical IR.
//
